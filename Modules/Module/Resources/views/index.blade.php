                            ...
                            <tbody>
                                <tr class="" v-for="module in moduleData">  
                                    ...
                                    <td class="text-center table_icon">                                    
                                        ...
                                        <a href="#" data-confirm-msg="Are you sure you would like to delete this module record?" data-delete-url="{{ url('admin/modules') }}/@{{ module.id }}" class="btn btn-icon-only js-delete-button outline-red" data-toggle="modal" data-target="#delete_modal">
