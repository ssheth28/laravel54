                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            <div class="input-group select2-bootstrap-prepend">
                                ...
                                <select class="form-control select2 select2-allow-clear select2-hide-search-box" tabindex="-98" id="parent_id" name="parent_id">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            <div class="input-group select2-bootstrap-prepend">
                                ...
                                {!! Form::select('is_active', config('config-variables.select_status'), $from=="edit" ? $module->is_active : null, ['class' => 'form-control select2 select2-allow-clear select2-hide-search-box', 'placeholder' => '-- Select Status --']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            <div class="input-group select2-bootstrap-prepend">
                                ...
                                {!! Form::select('is_publicly_visible', config('config-variables.is_publicly_visible'), $from=="edit" ? $module->is_publicly_visible : null, ['class' => 'form-control select2 select2-allow-clear select2-hide-search-box', 'id' => 'is_publicly_visible', 'placeholder' => '-- Select Is Publicly Visible? --']) !!}
                            </div>
                        </div>
                    </div>                              
                    {{-- <div class="col-md-6 col-lg-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            <div class="input-group select2-bootstrap-prepend">
                                ...
                                {!! Form::select('is_shown_on_menu', config('config-variables.is_shown_on_menu'), $from=="edit" ? $module->is_shown_on_menu : null, ['class' => 'form-control select2 select2-allow-clear select2-hide-search-box', 'placeholder' => 'Is Show On Menu?']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
