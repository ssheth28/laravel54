                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="form-group">
                            <div class="input-group select2-bootstrap-prepend">
                                ...
                                {!! Form::select('is_publicly_visible', config('config-variables.is_publicly_visible'), $from=="edit" ? $module->is_publicly_visible : null, ['class' => 'form-control select2 select2-allow-clear select2-hide-search-box', 'id' => 'is_publicly_visible', 'placeholder' => '-- Is Publicly Visible? --']) !!}
                            </div>
                        </div>
                    </div>                              
                    {{-- <div class="col-md-6 col-lg-3">
