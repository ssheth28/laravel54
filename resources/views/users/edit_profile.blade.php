                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <span class="input-group-addon no-bg"><i class="fa fa-sort-numeric-asc blue-color"></i></span>
                                                        {!! Form::select('department', $departments, isset($companyUser->settings['department']) ? $companyUser->settings['department'] : null, array('class' =>'form-control select2-allow-clear select2-hide-search-box')) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4">
